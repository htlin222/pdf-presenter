// Shared module loaded by both audience.html and presenter.html.
// Uses pdfjs-dist served from /assets/pdfjs/.
...
function readConfig() {
  ...
  if (!el) return { pdfUrl: "/slides.pdf", notesUrl: "/notes.json", timerMinutes: null };
  try {
    return JSON.parse(el.textContent || "{}");
  } catch {
    return { pdfUrl: "/slides.pdf", notesUrl: "/notes.json", timerMinutes: null };
  }
}
